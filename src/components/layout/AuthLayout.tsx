    ...
    <div className="min-h-screen bg-white flex flex-col md:flex-row">
      ...
      <div className="hidden md:flex md:w-1/2 bg-[#ECFDF5] flex-col justify-center items-center p-12">
        <div className="max-w-md text-center">
          ...
          <h1 className="text-4xl font-bold text-[#047857] mb-4">Soematra Kost</h1>
          <p className="text-[#047857]/80 text-lg">Kelola iuran, galon, laporan keuangan, dan jadwal kos dengan lebih transparan, tertib, dan aman.</p>
        </div>
      </div>
