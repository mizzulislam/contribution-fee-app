...
import type { JournalEntry, Account } from '@/lib/accounting'
import { filterJournalEntriesByPeriod, getPeriodLabel, type PeriodFilter } from '@/lib/accounting/period'
import JournalEntryModal from '@/components/accounting/JournalEntryModal'
import AccountingDownloadMenu from '@/components/accounting/AccountingDownloadMenu'
import { PlusCircle, Pencil, ArrowUpDown, Edit } from 'lucide-react'
...
export default function GeneralJournalView({ period }: GeneralJournalViewProps) {
  ...
  const handleDeleteSelected = async () => {
    if (!confirm(`Apakah Anda yakin ingin menghapus ${selectedIds.length} jurnal terpilih?`)) return
