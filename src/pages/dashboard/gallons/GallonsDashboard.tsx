...
import GallonPrediction from './GallonPrediction'
...
export default function GallonsDashboard() {
  ...
  const tabs = [
    { id: 'tracker', label: 'Stok Galon', icon: Droplets },
    { id: 'prediction', label: 'Prediksi Habis', icon: Activity },
    { id: 'vendors', label: 'Daftar Vendor', icon: Store },
  ]
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="pt-2">
        ...
        {activeTab === 'prediction' && <GallonPrediction />}
