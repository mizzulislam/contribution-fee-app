...
import { CategoryFormModal, PaymentMethodFormModal } from '@/features/settings/components/MasterFormModals'
...
export default function MasterData() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    if (editingId) {
      ...
      if (!res.success && (errMessage.includes('not found') || errMessage.includes('No data') || errMessage.includes('tidak ditemukan'))) {
